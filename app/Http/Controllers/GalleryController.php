        ...
        if($gallery_count > 0){
            ...
            foreach($gallery as $key => $gal){
                ...
                <tr>
                    ...
                    <td><img src="'.url('public/uploads/gallery/'.$gal->gallery_image).'" width="120" height="120px" class="img_thumbnail"></td>
                    <td>
                        <button type="button" data-gal_id="'.$gal->gallery_id.'" class="btn btn-xs btn-danger delete_gallery">Xóa</button>
                    </td>
                </tr>
                ';
            }
