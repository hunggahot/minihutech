                ...
                <div class="panel-body">
                    <div class="position-center">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" data-validation="number" data-validation-error-msg="Vui lòng nhập số lượng sản phẩm" name="product_quantity" class="form-control" id="exampleInputEmail1" value="{{$pro->product_quantity}}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="resize: none;" rows="8" name="product_des" class="form-control" id="exampleInputPassword1" placeholder="Mô tả sản phẩm">{{$pro->product_des}}</textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="product_tags" value="{{$pro->product_tags}}" data-role="tagsinput" class="form-control" >
                        </div>
                        <div class="form-group">
