                ...
                <div class="panel-body">
                    <div class="position-center">
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="resize: none;" rows="8" name="slider_des" class="form-control" id="exampleInputPassword1" placeholder="Mô tả danh mục"> </textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" name="add_brand_product" class="btn btn-info">Thêm Slider</button>
                    </form>
                    </div>
