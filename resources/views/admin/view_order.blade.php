          ...
          <tbody>
            ...
            @foreach($order_details as $key => $details)
              ...
              <tr class="color_qty_{{$details->product_id}}">
                ...
                <td>@if($details->product_coupon != 'không')
                ...
                <td>
                  <input type="number" min="1" {{$order_status == 2 ? 'disabled' : ''}} class="order_qty_{{$details->product_id}}" name="product_sales_quantity" value="{{$details->product_sales_quantity}}">
