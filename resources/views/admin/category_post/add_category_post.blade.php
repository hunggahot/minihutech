            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="position-center">
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">Tên slug danh mục bài viết</label>
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="resize: none;" rows="8" name="cate_post_des" class="form-control" id="exampleInputPassword1" placeholder="Mô tả danh mục"> </textarea>
                        </div>
                        <div class="form-group">
